/**
 * web-observer-react-sdk 类型定义
 * 核心类型从 web-observer-sdk 导入
 */
import type React from 'react';
export type { ErrorCollector, ErrorData, Framework, ErrorType } from 'web-observer-sdk';

/** Web Observer SDK 实例接口（挂载到 window 上的全局对象） */
